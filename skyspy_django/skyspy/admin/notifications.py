...
from skyspy.admin.actions import disable_selected, enable_selected, mark_verified
...
class NotificationChannelAdmin(admin.ModelAdmin):
    ...
    def test_notification(self, request, queryset):
        ...
        self.message_user(request, f"{updated} channel(s) tested and marked as verified.", messages.SUCCESS)
...
class NotificationLogAdmin(ExportCSVMixin, admin.ModelAdmin):
    ...
    def retry_failed(self, request, queryset):
        ...
        self.message_user(request, f"{updated} notification(s) queued for retry.", messages.SUCCESS)
...
class UserNotificationPreferenceAdmin(admin.ModelAdmin):
    ...
    def quiet_hours_display(self, obj):
        ...
        if obj.quiet_hours_start and obj.quiet_hours_end:
            return format_html(
                "{} - {}", obj.quiet_hours_start.strftime("%H:%M"), obj.quiet_hours_end.strftime("%H:%M")
            )
