...
class AntennaAnalyticsSnapshotAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Snapshot Info", {"fields": ("timestamp", "snapshot_type", "window_hours")}),
        (
            "Range Statistics",
            {
                "fields": (
        ...
        ("Signal Statistics", {"fields": ("best_rssi", "avg_rssi", "worst_rssi")}),
        (
            "Coverage Statistics",
            {
                "fields": (
        ...
        ("Performance", {"fields": ("estimated_gain_db", "performance_score")}),
    )
