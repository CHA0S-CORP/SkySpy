...
from skyspy.admin.filters import ActiveFilter, DateRangeFilter
...
class SkyspyUserAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("user", "display_name", "avatar_url")}),
        (
            "OIDC",
            {
...
class APIKeyAdmin(admin.ModelAdmin):
    ...
    list_display = ("name", "user", "key_prefix", "is_active", "expires_at", "last_used_at", "is_valid_display")
...
class OIDCClaimMappingAdmin(admin.ModelAdmin):
    ...
    list_display = ("name", "claim_name", "match_type", "claim_value", "role", "priority", "is_active")
