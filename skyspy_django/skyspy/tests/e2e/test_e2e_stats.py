...
class TestTrackingQualityStats:
    ...
    def test_tracking_quality_returns_200_ok(self, api_client, tracking_sessions_batch, sightings_for_sessions):
        """Test that tracking quality stats returns 200 OK."""
        response = api_client.get("/api/v1/stats/tracking-quality/")
        assert response.status_code == status.HTTP_200_OK

    def test_tracking_quality_response_structure(self, api_client, tracking_sessions_batch, sightings_for_sessions):
    ...
    def test_tracking_quality_filter_by_hours(self, api_client, tracking_sessions_batch, sightings_for_sessions):
    ...
    def test_tracking_quality_refresh_param(self, api_client, tracking_sessions_batch, sightings_for_sessions):
        """Test that refresh=true forces recalculation."""
        response = api_client.get("/api/v1/stats/tracking-quality/?refresh=true")
        assert response.status_code == status.HTTP_200_OK

    def test_tracking_quality_gaps_endpoint(self, api_client, tracking_sessions_batch, sightings_for_sessions):
    ...
    def test_tracking_quality_session_detail(self, api_client, tracking_sessions_batch, sightings_for_sessions):
...
class TestAircraftFavorites:
    ...
    def test_toggle_favorite_add(self, operator_client, operator_user):
        ...
        AircraftInfoFactory(icao_hex="NEWADD")
...
class TestCombinedStats:
    ...
    def test_combined_stats_includes_both_categories(self, api_client, flight_patterns_data, geographic_data):
    ...
    def test_combined_stats_filter_by_hours(self, api_client, flight_patterns_data, geographic_data):
...
class TestStatsIntegration:
    ...
    def test_all_stats_endpoints_return_json(self, api_client, tracking_sessions_batch, sightings_for_sessions):
    ...
    def test_stats_with_authenticated_user(self, operator_client, tracking_sessions_batch, favorites_data):
...
class TestStatsPermissions:
    ...
    def test_viewer_can_access_stats(self, viewer_client, tracking_sessions_batch, sightings_for_sessions):
    ...
    def test_analyst_has_full_stats_access(self, analyst_client, tracking_sessions_batch, sightings_for_sessions):
