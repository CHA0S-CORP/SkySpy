...
def identify_military_by_hex(icao_hex: str) -> dict[str, Any] | None:
    """
...
def identify_military_by_callsign(callsign: str) -> dict[str, Any] | None:
    """
...
def get_military_aircraft_type(type_code: str) -> dict[str, Any] | None:
    """
...
def get_interesting_category(type_code: str | None) -> str | None:
    """
