...
export const ICONS = {
  ...
  'eye-off': [
    [
      'path',
      {
        d: 'M9.9 4.2A10 10 0 0112 4c6.5 0 10 7 10 7a17 17 0 01-3 3.7M6 6.3A17 17 0 002 11s3.5 7 10 7a10 10 0 004.1-.9',
      },
    ],
    ['path', { d: 'M9.5 9.5a3 3 0 004.2 4.2M1 1l22 22' }],
  ],
  file: [
  ...
  'log-out': [['path', { d: 'M9 3H5a2 2 0 00-2 2v14a2 2 0 002 2h4M16 17l5-5-5-5M21 12H9' }]],
