...
from skyspy.admin.filters import AcknowledgedFilter, SeverityFilter, TimestampDateRangeFilter
...
class SafetyEventAdmin(ExportCSVMixin, admin.ModelAdmin):
    ...
    fieldsets = (
        ("Event Details", {"fields": ("timestamp", "event_type", "severity", "message")}),
        ("Primary Aircraft", {"fields": ("icao_hex", "callsign", "aircraft_snapshot")}),
        (
            "Secondary Aircraft",
            {
        ...
        ("Additional Details", {"fields": ("details",), "classes": ("collapse",)}),
        ("Acknowledgement", {"fields": ("acknowledged", "acknowledged_at")}),
    )
