...
class AircraftFavoriteAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("icao_hex", "registration", "callsign")}),
        (
            "Owner",
            {
...
class SessionTrackingQualityAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (
            "Position Metrics",
            {
                "fields": ("expected_positions", "actual_positions", "completeness_score", "avg_update_rate"),
            },
        ),
        (
            "Gap Metrics",
            {
                "fields": ("total_gaps", "max_gap_seconds", "avg_gap_seconds", "gap_percentage"),
            },
        ),
        (
            "Signal Quality",
