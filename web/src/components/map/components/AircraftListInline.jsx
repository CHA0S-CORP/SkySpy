...
/**
 * Inline aircraft list for CRT/Pro map modes.
 * Renders either a collapsed "show" button or the full expandable panel.
 */
const AircraftListInline = ({
  config,
  showAircraftList,
  setShowAircraftList,
  listExpanded,
...
export default AircraftListInline;
