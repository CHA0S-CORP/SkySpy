...
class TestNotificationChannelCRUD:
    ...
    def test_create_discord_channel(self, operator_client, operator_user):
        ...
        response = operator_client.post("/api/v1/notifications/channels/", data, format="json")
    ...
    def test_update_notification_channel(self, operator_client, notification_channels):
        ...
        response = operator_client.patch(f"/api/v1/notifications/channels/{channel.id}/", data, format="json")
    ...
    def test_cannot_update_other_users_channels(self, viewer_client, admin_user, db):
        ...
        response = viewer_client.patch(
            f"/api/v1/notifications/channels/{channel.id}/", {"name": "Hacked Name"}, format="json"
        )
...
class TestNotificationChannelTypes:
    ...
    def test_channel_types_include_expected_services(self, api_client):
        ...
        expected_types = ["discord", "slack", "telegram", "pushover", "email", "ntfy", "gotify", "webhook", "custom"]
    ...
    def test_discord_type_info(self, api_client):
        ...
        discord_type = next((t for t in data["types"] if t["type"] == "discord"), None)
    ...
    def test_slack_type_info(self, api_client):
        ...
        slack_type = next((t for t in data["types"] if t["type"] == "slack"), None)
...
class TestNotificationChannelTest:
    ...
    def test_send_test_notification_updates_channel_status(self, operator_client, notification_channels, mock_apprise):
        """Test that successful test notification updates channel verification status."""
        channel = notification_channels[0]
        assert channel.verified is False

        response = operator_client.post(f"/api/v1/notifications/channels/{channel.id}/test/", {}, format="json")
    ...
    def test_send_test_notification_logs_result(self, operator_client, notification_channels, mock_apprise, db):
    ...
    def test_send_test_notification_disabled_channel(self, operator_client, notification_channels, mock_apprise):
    ...
    def test_send_test_notification_validates_channel_config(self, operator_client, notification_channels):
...
class TestNotificationHistory:
    ...
    def test_filter_history_by_channel_id(self, operator_client, notification_channels, db):
        ...
        channel = notification_channels[0]
        NotificationLog.objects.create(notification_type="alert", channel=channel, status="sent")
        NotificationLog.objects.create(notification_type="alert", channel=notification_channels[1], status="sent")
...
class TestAlertChannelIntegration:
    ...
    def test_create_alert_with_notification_channels(self, operator_client, notification_channels, db):
    ...
    def test_failed_notifications_are_logged(self, operator_client, notification_channels, db):
...
class TestGlobalNotificationConfig:
    ...
    def test_update_global_notification_config(self, admin_client, global_notification_config):
        ...
        response = admin_client.patch("/api/v1/notifications/config/", data, format="json")
    ...
    def test_global_test_notification(self, operator_client, global_notification_config, mock_apprise):
        ...
        response = operator_client.post(
            "/api/v1/notifications/test/", {"title": "Global Test", "message": "Test message"}, format="json"
        )
    ...
    def test_global_test_notification_no_urls_configured(self, operator_client, db):
        ...
        response = operator_client.post("/api/v1/notifications/test/", {}, format="json")
...
class TestNotificationPermissions:
    ...
    def test_users_can_only_manage_own_channels(self, operator_client, viewer_client, operator_user, viewer_user, db):
    ...
    def test_admin_can_update_any_channel(self, admin_client, operator_user, db):
        ...
        response = admin_client.patch(
            f"/api/v1/notifications/channels/{channel.id}/", {"name": "Admin Updated"}, format="json"
        )
    ...
    def test_admin_can_create_global_channel(self, admin_client, admin_user):
        ...
        response = admin_client.post("/api/v1/notifications/channels/", data, format="json")
    ...
    def test_global_channels_visible_to_all_authenticated_users(self, viewer_client, admin_user, db):
...
class TestNotificationWorkflows:
    ...
    def test_complete_channel_workflow(self, operator_client, operator_user, mock_apprise):
        ...
        # 3. Test channel
        test_response = operator_client.post(f"/api/v1/notifications/channels/{channel_id}/test/", {}, format="json")
        assert test_response.status_code == status.HTTP_200_OK

        # 4. Update channel
        update_response = operator_client.patch(
            f"/api/v1/notifications/channels/{channel_id}/", {"name": "Updated Workflow Channel"}, format="json"
        )
    ...
    def test_alert_notification_workflow(self, operator_client, notification_channels, mock_apprise, db):
