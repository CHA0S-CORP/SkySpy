...
export function AircraftHeader({ hex, aircraft, info, tailInfo, shareSuccess, onShare, onClose }) {
  return (
    <header className="detail-header" role="banner">
      ...
      <div className="detail-header-actions">
        ...
        <button className="detail-close" onClick={onClose} aria-label="Close aircraft details">
