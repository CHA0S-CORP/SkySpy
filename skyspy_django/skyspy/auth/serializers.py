...
class CustomTokenObtainPairSerializer(TokenObtainPairSerializer):
    ...
    def validate(self, attrs):
        ...
        try:
            ...
            data["user"]["roles"] = [ur.role.name for ur in user.user_roles.all()]
...
class SkyspyUserSerializer(serializers.ModelSerializer):
    ...
    def get_roles(self, obj):
        return [{"name": ur.role.name, "display_name": ur.role.display_name} for ur in obj.user.user_roles.all()]
...
class UserCreateSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        # Create profile
        SkyspyUser.objects.create(user=user, display_name=display_name or user.username, auth_provider="local")
...
class APIKeyCreateSerializer(serializers.Serializer):
    ...
    def create(self, validated_data):
        ...
        user = User.objects.get(id=user_id) if user_id else self.context["request"].user
...
class FeatureAccessSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = FeatureAccess
        fields = ["feature", "feature_display", "read_access", "write_access", "is_enabled", "settings", "updated_at"]
