...
# --application-close-timeout 30: Give sync views more time to complete during shutdown
CMD ["daphne", "-b", "0.0.0.0", "-p", "8000", "--application-close-timeout", "30", "skyspy.asgi:application"]
