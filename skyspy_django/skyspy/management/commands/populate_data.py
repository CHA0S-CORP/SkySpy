...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        results = self._queue_async_tasks(skip_openaip) if run_async else self._run_sync_tasks(skip_openaip, force)
    ...
    def _run_sync_tasks(self, skip_openaip: bool, force: bool) -> dict:
        ...
        if skip_openaip:
            ...
            self.stdout.write(self.style.WARNING("  [7/7] Skipping OpenAIP (OPENAIP_ENABLED=False or no API key)"))
