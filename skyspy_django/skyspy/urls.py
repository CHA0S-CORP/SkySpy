...
from skyspy.api.cannonball import (
    CannonballActivateView,
    CannonballAlertViewSet,
    CannonballKnownAircraftViewSet,
    CannonballLocationView,
    CannonballPatternViewSet,
    CannonballSessionViewSet,
    ...
    path(
        ...
        include(
            [
                ...
                path(
                    "photos/<str:icao_hex>/<str:photo_type>/", PhotoServeView.as_view(), name="photo-serve-type-slash"
                ),
            ]
        ),
    ),
