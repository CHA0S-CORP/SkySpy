...
from skyspy.admin.filters import ArchivedFilter, DateRangeFilter
from skyspy.admin.mixins import ExportCSVMixin
from skyspy.models import CachedAircraftType, CachedAirline, CachedNotam
...
class CachedNotamAdmin(ExportCSVMixin, admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("notam_id", "notam_type", "classification")}),
        ("Location", {"fields": ("location", "latitude", "longitude", "radius_nm")}),
        ("Altitude", {"fields": ("floor_ft", "ceiling_ft")}),
        ("Validity", {"fields": ("effective_start", "effective_end", "is_permanent")}),
        ("Content", {"fields": ("text", "raw_text", "keywords", "reason")}),
