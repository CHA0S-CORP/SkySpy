...
class TestAlertRuleCRUD:
    ...
    def test_update_own_alert_rule(self, operator_client, sample_alert_rule):
        ...
        response = operator_client.patch(f"/api/v1/alerts/rules/{sample_alert_rule.id}/", data, format="json")
    ...
    def test_cannot_edit_other_users_private_rules(self, operator_client, admin_user):
        ...
        response = operator_client.patch(f"/api/v1/alerts/rules/{rule.id}/", {"name": "Hacked!"}, format="json")
...
class TestAlertRuleVisibility:
    ...
    def test_shared_rules_visible_to_users_with_alerts_view_permission(self, viewer_client, shared_alert_rule):
    ...
    def test_admin_with_manage_all_can_edit_any_rule(self, admin_client, operator_user):
        ...
        response = admin_client.patch(
            f"/api/v1/alerts/rules/{rule.id}/", {"name": "Admin Modified Rule"}, format="json"
        )
...
class TestAlertTesting:
    ...
    def test_post_test_with_sample_aircraft_data(self, operator_client, sample_alert_rule):
        ...
        response = operator_client.post(
            f"/api/v1/alerts/rules/{sample_alert_rule.id}/test/", {"aircraft": aircraft_data}, format="json"
        )
    ...
    def test_test_returns_match_results(self, operator_client, operator_user):
        ...
        response = operator_client.post(
            f"/api/v1/alerts/rules/{rule.id}/test/", {"aircraft": aircraft_data}, format="json"
        )
    ...
    def test_complex_conditions_evaluate_correctly(self, operator_client, complex_alert_rule):
        ...
        response = operator_client.post(
            f"/api/v1/alerts/rules/{complex_alert_rule.id}/test/", {"aircraft": matching_aircraft}, format="json"
        )
        ...
        response = operator_client.post(
            f"/api/v1/alerts/rules/{complex_alert_rule.id}/test/", {"aircraft": non_matching_aircraft}, format="json"
        )
...
class TestBulkOperations:
    ...
    def test_bulk_delete_multiple_rules(self, operator_client, operator_user):
        ...
        response = operator_client.delete(
            "/api/v1/alerts/rules/bulk_delete/", {"ids": [rule1.id, rule2.id, rule3.id]}, format="json"
        )
    ...
    def test_bulk_delete_only_deletes_owned_rules(self, operator_client, operator_user, admin_user):
        ...
        response = operator_client.delete(
            "/api/v1/alerts/rules/bulk_delete/", {"ids": [owned_rule.id, other_rule.id]}, format="json"
        )
...
class TestAlertSubscriptions:
    ...
    def test_subscribe_to_shared_alert_rule(self, operator_client, operator_user, shared_alert_rule):
        ...
        response = operator_client.post(
            "/api/v1/alerts/subscriptions/", {"rule_id": shared_alert_rule.id}, format="json"
        )
        ...
        assert AlertSubscription.objects.filter(user=operator_user, rule=shared_alert_rule).exists()
    ...
    def test_unsubscribe_from_rule(self, operator_client, operator_user, shared_alert_rule):
        ...
        response = operator_client.delete(f"/api/v1/alerts/subscriptions/{shared_alert_rule.id}/")

        assert response.status_code == status.HTTP_204_NO_CONTENT

        # Verify subscription removed
        assert not AlertSubscription.objects.filter(user=operator_user, rule=shared_alert_rule).exists()
    ...
    def test_cannot_subscribe_to_private_rule_not_owned(self, operator_client, admin_user):
        ...
        response = operator_client.post("/api/v1/alerts/subscriptions/", {"rule_id": private_rule.id}, format="json")
...
class TestEdgeCasesAndErrors:
    ...
    def test_test_nonexistent_rule(self, operator_client):
        ...
        response = operator_client.post("/api/v1/alerts/rules/99999/test/", {"aircraft": {}}, format="json")
    ...
    def test_duplicate_subscription(self, operator_client, operator_user, public_alert_rule):
        ...
        response = operator_client.post(
            "/api/v1/alerts/subscriptions/", {"rule_id": public_alert_rule.id}, format="json"
        )
...
class TestIntegrationWorkflows:
    ...
    def test_complete_alert_rule_lifecycle(self, operator_client, operator_user):
        ...
        test_response = operator_client.post(
            f"/api/v1/alerts/rules/{rule_id}/test/", {"aircraft": {"hex": "A12345", "squawk": "7700"}}, format="json"
        )
    ...
    def test_shared_rule_subscription_workflow(self, operator_client, viewer_client, admin_user, operator_user):
        ...
        sub_response = operator_client.post("/api/v1/alerts/subscriptions/", {"rule_id": rule.id}, format="json")
