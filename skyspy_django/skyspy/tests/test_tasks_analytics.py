...
class CalculateDailyStatsTaskTest(TestCase):
    ...
    def test_daily_stats_calculates_yesterday(self):
        ...
        AircraftSighting.objects.filter(pk=sighting.pk).update(timestamp=yesterday.replace(hour=12, minute=0))
    ...
    def test_daily_stats_excludes_today(self):
        ...
        AircraftSighting.objects.filter(pk=yesterday_sighting.pk).update(timestamp=yesterday.replace(hour=12))
    ...
    def test_daily_stats_military_count(self):
        ...
        AircraftSession.objects.filter(pk=civilian.pk).update(last_seen=yesterday.replace(hour=12))
        ...
        for i in range(3):
            ...
            AircraftSession.objects.filter(pk=military.pk).update(last_seen=yesterday.replace(hour=12))
    ...
    def test_daily_stats_distance_calculations(self):
        ...
        for i, distance in enumerate(distances):
            ...
            AircraftSighting.objects.filter(pk=sighting.pk).update(timestamp=yesterday.replace(hour=12))
    ...
    def test_daily_stats_unique_aircraft_count(self):
        ...
        for i in range(5):
            ...
            AircraftSighting.objects.filter(pk=sighting.pk).update(timestamp=yesterday.replace(hour=12, minute=i))
        ...
        AircraftSighting.objects.filter(pk=other.pk).update(timestamp=yesterday.replace(hour=14))
