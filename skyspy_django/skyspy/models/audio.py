...
class AudioTransmission(models.Model):
    ...
    transcription_status = models.CharField(
        max_length=20, choices=TRANSCRIPTION_STATUS_CHOICES, default="pending", db_index=True
    )
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=["transcription_status", "created_at"], name="idx_audio_transmission_status"),
