...
<!-- Auto-generated by `npm run docs:generate` (web/). Do not edit between the SCREENSHOTS markers. -->
...
![Aircraft List Column Menu](screenshots/desktop/aircraft-list-column-menu.png)
![Aircraft List Filtered](screenshots/desktop/aircraft-list-filtered.png)
![Aircraft List Mobile](screenshots/desktop/aircraft-list-mobile.png)
![Aircraft List Row Expanded](screenshots/desktop/aircraft-list-row-expanded.png)
![Aircraft List Sorted](screenshots/desktop/aircraft-list-sorted.png)
![Aircraft List Table](screenshots/desktop/aircraft-list-table.png)
...
![Stats Cards Overview](screenshots/desktop/stats-cards-overview.png)
![Stats Charts](screenshots/desktop/stats-charts.png)
![Stats Coverage](screenshots/desktop/stats-coverage.png)
![Stats Dashboard](screenshots/desktop/stats-dashboard.png)
![Stats Time Range](screenshots/desktop/stats-time-range.png)
![Stats Top Aircraft](screenshots/desktop/stats-top-aircraft.png)
...
![System Overview](screenshots/desktop/system-overview.png)
![System Services](screenshots/desktop/system-services.png)
