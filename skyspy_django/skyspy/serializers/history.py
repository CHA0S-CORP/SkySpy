...
class HistoryStatsSerializer(serializers.Serializer):
    ...
    avg_altitude = serializers.IntegerField(required=False, allow_null=True, help_text="Average altitude in feet")
    max_altitude = serializers.IntegerField(required=False, allow_null=True, help_text="Maximum altitude in feet")
    min_altitude = serializers.IntegerField(required=False, allow_null=True, help_text="Minimum altitude in feet")
    avg_distance_nm = serializers.FloatField(
        required=False, allow_null=True, help_text="Average distance in nautical miles"
    )
    max_distance_nm = serializers.FloatField(
        required=False, allow_null=True, help_text="Maximum distance in nautical miles"
    )
    avg_speed = serializers.IntegerField(required=False, allow_null=True, help_text="Average ground speed in knots")
    max_speed = serializers.IntegerField(required=False, allow_null=True, help_text="Maximum ground speed in knots")
    filters_applied = serializers.DictField(required=False, allow_null=True, help_text="Filters that were applied")


class TrendIntervalSerializer(serializers.Serializer):
    """Single interval in trend data."""

    timestamp = serializers.CharField(required=False, allow_null=True, help_text="Interval start timestamp")
    ...
    avg_altitude = serializers.IntegerField(required=False, allow_null=True, help_text="Average altitude")
    max_altitude = serializers.IntegerField(required=False, allow_null=True, help_text="Maximum altitude")
    avg_distance_nm = serializers.FloatField(required=False, allow_null=True, help_text="Average distance")
    max_distance_nm = serializers.FloatField(required=False, allow_null=True, help_text="Maximum distance")
    avg_speed = serializers.IntegerField(required=False, allow_null=True, help_text="Average speed")
    max_speed = serializers.IntegerField(required=False, allow_null=True, help_text="Maximum speed")


class TrendSummarySerializer(serializers.Serializer):
    """Summary of trend data."""

    total_unique_aircraft = serializers.IntegerField(help_text="Total unique aircraft in range")
    peak_concurrent = serializers.IntegerField(help_text="Peak concurrent aircraft")
    peak_interval = serializers.CharField(required=False, allow_null=True, help_text="Interval with peak aircraft")
...
class TopPerformerEntrySerializer(serializers.Serializer):
    ...
    callsign = serializers.CharField(required=False, allow_null=True, help_text="Flight callsign")
    aircraft_type = serializers.CharField(required=False, allow_null=True, help_text="Aircraft type code")
    is_military = serializers.BooleanField(help_text="Military aircraft flag")
    first_seen = serializers.CharField(required=False, allow_null=True, help_text="First seen timestamp")
    last_seen = serializers.CharField(required=False, allow_null=True, help_text="Last seen timestamp")
    duration_min = serializers.FloatField(required=False, allow_null=True, help_text="Tracking duration in minutes")
    positions = serializers.IntegerField(required=False, allow_null=True, help_text="Position report count")
    min_distance_nm = serializers.FloatField(required=False, allow_null=True, help_text="Minimum distance")
    max_distance_nm = serializers.FloatField(required=False, allow_null=True, help_text="Maximum distance")
    min_altitude = serializers.IntegerField(required=False, allow_null=True, help_text="Minimum altitude")
    max_altitude = serializers.IntegerField(required=False, allow_null=True, help_text="Maximum altitude")
    max_speed = serializers.IntegerField(required=False, allow_null=True, help_text="Maximum ground speed")


class TopPerformersSerializer(serializers.Serializer):
    """Response for top performers endpoint."""

    longest_tracked = TopPerformerEntrySerializer(many=True, help_text="Longest tracked sessions")
    furthest_distance = TopPerformerEntrySerializer(many=True, help_text="Furthest distance sessions")
    highest_altitude = TopPerformerEntrySerializer(many=True, help_text="Highest altitude sessions")
    most_positions = TopPerformerEntrySerializer(many=True, help_text="Most positions sessions")
    closest_approach = TopPerformerEntrySerializer(many=True, help_text="Closest approach sessions")
    time_range_hours = serializers.IntegerField(help_text="Time range in hours")
