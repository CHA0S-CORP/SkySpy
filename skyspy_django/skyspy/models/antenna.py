...
class AntennaAnalyticsSnapshot(models.Model):
    ...
    snapshot_type = models.CharField(max_length=20, choices=SNAPSHOT_TYPES, default="scheduled", db_index=True)
    ...
    def get_range(cls, start_time, end_time, snapshot_type="scheduled"):
        ...
        return cls.objects.filter(
            timestamp__gte=start_time, timestamp__lte=end_time, snapshot_type=snapshot_type
        ).order_by("timestamp")
