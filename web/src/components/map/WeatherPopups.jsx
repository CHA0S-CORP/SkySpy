 ...
 */
export const MetarPopup = memo(function MetarPopup({
  metar,
  onClose,
  mapMode,
  getDistanceNm,
    ...
    >
      ...
      <div className="popup-header">
        ...
        <span id={titleId} className="popup-callsign">
          {metar.icaoId || metar.stationId || 'METAR'}
        </span>
 ...
 * Memoized to prevent re-renders when other map state changes
 */
export const PirepPopup = memo(function PirepPopup({
  pirep,
  onClose,
  mapMode,
  getDistanceNm,
  ...
  return (
    ...
    >
      ...
      <div className="popup-header">
        ...
        <span id={titleId} className="popup-callsign">
          {decoded?.location || pirep.icaoId || 'PIREP'}
        </span>
        <span
          className={`pirep-type-badge ${(pirep.report_type || pirep.pirepType)?.toLowerCase() || 'ua'}`}
        >
      ...
      <div className="popup-details">
        ...
        {decoded?.wind && (
          <div className="detail-row">
            ...
            <span>
              {windDirToCardinal(decoded.wind.direction)} at {decoded.wind.speed}kt
            </span>
          </div>
        )}
 ...
 * Memoized to prevent re-renders when other map state changes
 */
export const NavaidPopup = memo(function NavaidPopup({
  navaid,
  onClose,
  mapMode,
  getDistanceNm,
 ...
 * Memoized to prevent re-renders when other map state changes
 */
export const AirportPopup = memo(function AirportPopup({
  airport,
  onClose,
  mapMode,
  getDistanceNm,
